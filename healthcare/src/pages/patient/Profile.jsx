  ...
  return (
    <Box sx={{ p: { xs: 2, md: 4 }, bgcolor: "#f9fafb", minHeight: "100vh" }}>
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Typography variant="h4" fontWeight={700}>Patient Profile</Typography>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          ...
          <Card elevation={2} sx={{ borderRadius: 3, mt: 2 }}>
            <CardContent>
              <Typography variant="h6" fontWeight={700} gutterBottom>Medical Overview</Typography>
              <TextField
        ...
        <Grid item xs={12} md={8}>
          <Card elevation={2} sx={{ borderRadius: 3 }}>
            <CardContent>
              <Typography variant="h6" fontWeight={700} gutterBottom>Vitals</Typography>
              <Grid container spacing={2}>
                ...
                <Grid item xs={6} md={3}>
                  <TextField
                    label="BMI"
                    value={getBMI(Number(form.vitals.weight), Number(form.vitals.height))}
                    fullWidth
                    disabled
                  />
                </Grid>
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12} md={6}>
              <Card elevation={2} sx={{ borderRadius: 3 }}>
                <CardContent>
                  <Typography variant="h6" fontWeight={700} gutterBottom>Chronic Illnesses</Typography>
                  <Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mb: 2 }}>
                    {form.chronic.map((c, idx) => (
                      <Chip key={`${c}-${idx}`} label={c} onDelete={() => removeFromArray("chronic", idx)} />
                    ))}
                  </Stack>
                  <Stack direction="row" spacing={1}>
                    <TextField
            ...
            <Grid item xs={12} md={6}>
              <Card elevation={2} sx={{ borderRadius: 3 }}>
                <CardContent>
                  <Typography variant="h6" fontWeight={700} gutterBottom>Surgeries</Typography>
                  <Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mb: 2 }}>
                    {form.surgeries.map((s, idx) => (
                      <Chip key={`${s}-${idx}`} label={s} onDelete={() => removeFromArray("surgeries", idx)} />
                    ))}
                  </Stack>
                  <Stack direction="row" spacing={1}>
                    <TextField
            ...
            <Grid item xs={12} md={6}>
              <Card elevation={2} sx={{ borderRadius: 3 }}>
                <CardContent>
                  <Typography variant="h6" fontWeight={700} gutterBottom>Insurance & Social</Typography>
                  <TextField
                    label="Insurance"
                    fullWidth
                    sx={{ mb: 2 }}
                  ...
                  <TextField
                    ...
                    onChange={(e) => handleField("familyHistory", e.target.value)}
                  />
                  <TextField
          ...
          <Card elevation={2} sx={{ borderRadius: 3, mt: 2 }}>
            <CardContent>
              <Typography variant="h6" fontWeight={700} gutterBottom>Medications</Typography>
              ...
              <Stack direction={{ xs: "column", sm: "row" }} spacing={1}>
                <TextField
                  ...
                  size="small"
                  value={newMed.name}
                  onChange={(e) => setNewMed((nm) => ({ ...nm, name: e.target.value }))}
                  sx={{ minWidth: 200 }}
                />
                <TextField
                  label="Dosage"
                  size="small"
                  value={newMed.dosage}
                  onChange={(e) => setNewMed((nm) => ({ ...nm, dosage: e.target.value }))}
                  sx={{ minWidth: 160 }}
                />
                <TextField
                  label="Frequency"
                  ...
                  onChange={(e) => setNewMed((nm) => ({ ...nm, frequency: e.target.value }))}
                  sx={{ minWidth: 160 }}
                />
